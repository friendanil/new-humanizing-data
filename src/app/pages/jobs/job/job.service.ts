  ...
  if (applicantData?.length) {
    const applicantList = applicantData?.map((applicant: any) => {
      ...
      return {
        ...
        profileImage: applicantUserData?.the_user_profile?.[userProfileIndex]?.data?.the_profile?.the_profile_profilePic?.[0]?.data?.the_profilePic || applicantUserData?.entity?.person?.profile_img,
        fname: applicantUserData?.the_user_profile?.[userProfileIndex]?.data?.the_profile?.the_profile_first_name?.[0]?.data?.the_first_name || applicantUserData?.entity?.person?.first_name,
        lname: applicantUserData?.the_user_profile?.[userProfileIndex]?.data?.the_profile?.the_profile_last_name?.[0]?.data?.the_last_name || applicantUserData?.entity?.person?.last_name,
        ...
        email: applicantUserData?.the_user_profile?.[userProfileIndex]?.data?.the_profile?.the_profile_email?.[0]?.data?.the_email || applicantUserData?.entity?.person?.email,
        location: applicantUserData?.entity?.person?.location,
        phone:applicantUserData?.the_user_profile?.[userProfileIndex]?.data?.the_profile?.the_profile_phone?.[0]?.data?.the_phone||applicantUserData?.entity?.person?.phone,
      };
    });
